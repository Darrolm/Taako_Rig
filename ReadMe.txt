...
- Space settings for hat, glasses, arms, legs.

- Mass clean up to verify each control doesn't have more attributes than it should while locking attributes on null layers.

- Rework Umbrastaff rig for stability. It's occasionally wonky at the moment.

- Import Umbrastaff rig into primary character file

- Potentially set up the controls using Maya 2018 and beyond controller tags? 
